...
* `eslint`
  ...
  [] === false                   // false
  [] == false                    // true  令人疑惑的结果. [].toString() => '' == false

  var a = 1
  // ...
  var a = 2                      // 重复定义变量

  undefined = 'xxx'              // undefined 不再是 undefined
...
* 懒加载
  ...
  - async, defer
    ...
    <!-- 不阻塞，并行下载，完按出现顺序执行，在DOMContentLoaded前 -->
    <script src=c.js defer></script>
    <!-- 不阻塞，并行下载，完立即执行不保证顺序，不保证在DOMContentLoaded前 -->
